...
import CurrentFilm from '@components/ciurrent-film/current-film.tsx';
      ...
      <div className="page-content">
        <section className="catalog catalog--like-this">
          ...
          <div className="catalog__films-list">
            <SmallFilmCardLink title={'Fantastic Beasts: The Crimes of Grindelwald'} img={'img/fantastic-beasts-the-crimes-of-grindelwald.jpg'}/>
